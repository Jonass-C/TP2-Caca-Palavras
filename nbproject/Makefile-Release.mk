...
${OBJECTDIR}/src/Coordenadas.o: src/Coordenadas.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Coordenadas.o src/Coordenadas.c

${OBJECTDIR}/src/Matriz.o: src/Matriz.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Matriz.o src/Matriz.c

${OBJECTDIR}/src/Ocorrencias.o: src/Ocorrencias.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Ocorrencias.o src/Ocorrencias.c

${OBJECTDIR}/src/Palavras.o: src/Palavras.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Palavras.o src/Palavras.c
